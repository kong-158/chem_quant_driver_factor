...
因此，当前项目优先采用 AkShare 路径；Playwright 报价爬虫作为补源和监控工具，用于覆盖 MDI、TDI、制冷剂、钛白粉、黄磷、草甘膦等 AkShare 期现接口暂未覆盖的品种。
...
1. 运行 `scripts/scrape_100ppi_quotes_playwright.py` 抓取生意社最新报价，并对目标 driver 做关键词匹配。
